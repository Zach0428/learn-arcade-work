...
class MyGame(arcade.View):
    ...
    def on_draw(self):
        ...
        output_left = "Coins left: " + str(self.count_down)
        arcade.draw_text(output_left, 5, 25, arcade.color.WHITE, 16)
    ...
    def on_update(self, delta_time):
        if self.player_sprite.cur_health > 0:
            ...
            for bullet in self.bullet_list:
                ...
                bullet_wall = arcade.check_for_collision_with_list(bullet, self.wall_list)
